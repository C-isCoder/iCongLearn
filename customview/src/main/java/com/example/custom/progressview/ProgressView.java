package com.example.custom.progressview;
...
public class ProgressView extends View {
  ...
  @TargetApi(Build.VERSION_CODES.LOLLIPOP) @Override protected void onDraw(Canvas canvas) {
    ...
    canvas.drawArc(mArcRect, -90, angle, false, mProgressPaint);
    mTextPaint.getTextBounds(mText, 0, mText.length(), mTextBounds);
    canvas.drawText(mText, centerX, centerY - mTextBounds.centerY(), mTextPaint);
  }
}
