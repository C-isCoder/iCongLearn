...
public class GenerateActivity extends CommonActivity {
    ...
    private void createChineseQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(GenerateActivity.this.getResources(), R.mipmap.logo);
    ...
    private void createEnglishQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(GenerateActivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(GenerateActivity.this, 150), Color.BLACK, Color.WHITE, logoBitmap);
            }
