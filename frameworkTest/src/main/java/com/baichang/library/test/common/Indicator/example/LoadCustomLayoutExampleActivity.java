...
import com.baichang.android.widget.magicIndicator.buildins.commonnavigator.titles.CommonPagerTitleView;
...
public class LoadCustomLayoutExampleActivity extends CommonActivity {
  ...
  private void initMagicIndicator1() {
    ...
    commonNavigator.setAdapter(new CommonNavigatorAdapter() {
      ...
      @Override public IPagerTitleView getTitleView(Context context, final int index) {
        ...
        // load custom layout
        View customLayout =
            LayoutInflater.from(context).inflate(R.layout.simple_pager_title_layout, null);
        ...
        commonPagerTitleView.setOnPagerTitleChangeListener(
            new CommonPagerTitleView.OnPagerTitleChangeListener() {
              ...
              @Override public void onLeave(int index, int totalCount, float leavePercent,
                  boolean leftToRight) {
                titleImg.setScaleX(1.3f + (0.8f - 1.3f) * leavePercent);
                titleImg.setScaleY(1.3f + (0.8f - 1.3f) * leavePercent);
              }

              @Override public void onEnter(int index, int totalCount, float enterPercent,
                  boolean leftToRight) {
