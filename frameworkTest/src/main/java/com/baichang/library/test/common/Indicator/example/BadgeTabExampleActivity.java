...
public class BadgeTabExampleActivity extends CommonActivity {
  ...
  private void initMagicIndicator1() {
    ...
    commonNavigator.setAdapter(new CommonNavigatorAdapter() {
      ...
      @Override public IPagerTitleView getTitleView(Context context, final int index) {
        ...
        // setup badge
        if (index != 2) {
          TextView badgeTextView = (TextView) LayoutInflater.from(context)
          ...
          ImageView badgeImageView = (ImageView) LayoutInflater.from(context)
        ...
        if (index == 0) {
          badgePagerTitleView.setXBadgeRule(
              new BadgeRule(BadgeAnchor.CONTENT_LEFT, -UIUtil.dip2px(context, 6)));
          badgePagerTitleView.setYBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_TOP, 0));
        } else if (index == 1) {
          badgePagerTitleView.setXBadgeRule(
              new BadgeRule(BadgeAnchor.CONTENT_RIGHT, -UIUtil.dip2px(context, 6)));
          badgePagerTitleView.setYBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_TOP, 0));
        } else if (index == 2) {
          badgePagerTitleView.setXBadgeRule(
              new BadgeRule(BadgeAnchor.CENTER_X, -UIUtil.dip2px(context, 3)));
          badgePagerTitleView.setYBadgeRule(
              new BadgeRule(BadgeAnchor.CONTENT_BOTTOM, UIUtil.dip2px(context, 2)));
        }
  ...
  private void initMagicIndicator3() {
    ...
    commonNavigator.setAdapter(new CommonNavigatorAdapter() {
      ...
      @Override public IPagerIndicator getIndicator(Context context) {
        LinePagerIndicator indicator = new LinePagerIndicator(context);
        float navigatorHeight =
            context.getResources().getDimension(R.dimen.common_navigator_height);
