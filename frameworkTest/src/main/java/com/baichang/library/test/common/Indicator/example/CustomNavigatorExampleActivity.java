...
import com.baichang.android.widget.magicIndicator.buildins.circlenavigator.CircleNavigator;
import com.baichang.library.test.R;
import com.baichang.library.test.base.CommonActivity;
import com.baichang.library.test.common.Indicator.ext.navigator.ScaleCircleNavigator;

import java.util.Arrays;
import java.util.List;

public class CustomNavigatorExampleActivity extends CommonActivity {
