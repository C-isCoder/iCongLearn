...
public class SelectPhotoActivity extends CommonActivity
    implements PhotoSelectDialog.OnResultListener, PhotoSelectDialog.PhotoSelectCallback {
  ...
  @OnClick(R.id.button) void select() {
  ...
  @Override public void onResult(Bitmap bitmap, String path) {
    showMessage(path);
    ivImage.setImageBitmap(bitmap);
  }
}
