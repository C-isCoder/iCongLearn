...
public class TasksRemoteDataSource implements TasksDataSource {
  ...
  /**
   * Note: {@link GetTaskCallback#onDataNotAvailable()} is never fired. In a real remote data source
   * implementation, this would be fired if the server can't be contacted or the server returns an
   * error.
   */
  @Override
